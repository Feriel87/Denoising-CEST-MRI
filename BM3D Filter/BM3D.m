...
N2                  = 32;  %% maximum number of similar blocks (maximum size of the 3rd dimension of a 3D array)
Ns                  = 9;  %% length of the side of the search neighborhood for full-search block-matching (BM), must be odd
